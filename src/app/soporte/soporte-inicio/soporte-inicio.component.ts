...
@Component({
  selector: 'app-soporte-inicio',
  templateUrl: './soporte-inicio.component.html',
  styleUrls: ['./soporte-inicio.component.css']
})
export class SoporteInicioComponent implements OnInit {
