...
@Component({
  selector: 'app-mensajes-reporte',
  templateUrl: './mensajes-reporte.component.html',
  styleUrls: ['./mensajes-reporte.component.css']
})
export class MensajesReporteComponent implements OnInit {
  ...
  async getReports(): Promise<void> {
    await this.firestore.getCollectionTwoArguments<Reportes>('reportes', 'atendido', this.uId, 'estatus', 'Verificando').subscribe((reports) => {
